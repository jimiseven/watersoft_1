                    ...
                    <tbody>
                        <?php while ($consumo = $consumos_result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($consumo['estado'] === 'pagado') { ?>
                                        Pagado
                                    <?php } else { ?>
                                        <a href="realizar_pago.php?factura_id=<?php echo $consumo['factura_id']; ?>&usuario_id=<?php echo $usuario_id; ?>" class="btn btn-warning btn-sm">Pendiente</a>
                                    <?php } ?>
                                </td>
